...
#define L  500
#define G  1.183e-4		/* ��ͭ���������ŷʸñ�̷� */
#define M  332950		/* 2�Ĥ����ۤμ��� */
#define m0 1			/* �ϵ�μ��� 0�� */
#define SN 15000
#define SC 10
...
void init(void *_prms)
{
  ...
  for (i = 0; i < 6 * N; i++)
    p->r[i] = 0;
  p->r[0] = 1;			/* �ϵ�θ�žȾ�¤ν������ x=0 */
  p->r[4] = sqrt(M * m0 * G);	/* �ϵ�θ�ž®�٤�y�����ν�®�٤�Ϳ���� */
  p->r[12] = *p->x0;
  p->r[13] = -20;
  p->r[16] = *p->vy0;
  *p->t = 0;
...
int main()
{
  ...
  e_ctrl ctrls[] = {
    {"Theta", &th, 1, &redraw, &prms},	/* ��̤�������Ѥ��Ƥߤ����Τ� */
    {"Phi", &phi, -1, &redraw, &prms},	/* init ���ʤ�                  */
